...
export function PortsDialog({
  ...
  return (
    ...
    >
      <DialogContent
        className="flex h-[min(44rem,85vh)] flex-col gap-5 overflow-y-auto rounded-2xl sm:max-w-3xl"
      ...
      >
        <DialogHeader className="shrink-0">
          <DialogTitle className="flex items-center gap-2 text-xl">
            <Network className="size-5 text-primary" /> Open ports
          </DialogTitle>
          <DialogDescription>
              ...
              <tr>
                ...
                <th scope="col" className="px-3 py-3 text-right font-medium">
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-64">
                      Resident memory (RSS / working set) for this process, excluding child
                      processes.
                    </TooltipContent>
                  </Tooltip>
                </th>
        ...
        {selected && (
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">
              This stops the process and closes all of its ports, including port {selected.port}.
            </p>
